...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>TIW Vinted - Producto</title>
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-7">
                                    <div class="product-content">
                                        <div class="title"><h2><%=request.getAttribute("nombre")%></h2></div>
                                        
                                        <div class="price">
                                            <h4>Precio:</h4>
                                            <p><%=request.getAttribute("precio") %></p>
                                        </div>
                                        <div class="quantity">
                                            <h4>Cantidad:</h4>
                                            <div class="qty">
                                        ...
                                        <div class="action">
                                            <a class="btn" href="carrito.html?id_producto=<%= producto.getId() %>"><i class="fa fa-shopping-cart"></i>Añadir al Carro</a>
                        ...
                        <div class="row product-detail-bottom">
                            <div class="col-lg-12">
                                ...
                                <div id="description" class="container tab-pane active">
                                        <h4>Categoría</h4>
                                        <p><%=request.getAttribute("categoria") %></p>
                                    </div>
                                </div>
                                    <div id="description" class="container tab-pane active">
